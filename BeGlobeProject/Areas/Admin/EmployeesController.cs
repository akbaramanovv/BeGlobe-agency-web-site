...
namespace BeGlobeProject.Areas.Admin
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,EmployeeName,Surname,PositionID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,EmployeeName,Surname,PositionID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
